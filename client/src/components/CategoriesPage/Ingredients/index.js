...
class Ingredients extends React.Component {
  ...
  handleSearch = () => {
    ...
    fetch("/api/categories", {
      ...
      .then(data => data.json())
      .then(d => this.props.setRecipes(d));
  };
      ...
      <div class="category-content">
        <div class="category">
          ...
          <div class="row about buttons">
            ...
            <p class="subhead">
              Please choose a category below to view a list of ingredients to
              add to your fridge
            </p>
            <br />
            ...
            <div class="dairy">
              <div id="dairy-ingred-menu" class="row">
                ...
                <div class="add-ingred input-field col s12 l2">
                  <a
                    class="btn-floating btn-small waves-effect waves-light z-depth-0 addition"
                    data-category="dairy"
                  >
          ...
          {this.state.searchButton === true ? (
            <button
              ...
              className="btn waves-effect waves-light submit modal-trigger z-depth-0"
              name="action"
            >
              Search for Recipes
